    ...
    <div>
        ...
        <div className='dash-container'>
            ...
            <div className='loan-nav'>
                    ...
                    <ArrowForwardIosOutlinedIcon className='loannav-icon'/>
                    <Link to='/active' className='active-loannav'>Active Loan Application</Link>
                </div>
                ...
                <div className='loan-links'>
                    ...
                    <Link to='/active' className='all-loanlink'>Active</Link>
                    ...
                    <tbody>
                        {data.map((data) => {
                            ...
                            <tr key={data.id} style={{background: checkdItems[data.id] ? '#F0F4FC' : 'white'}} className='loantable-data'>
                                ...
                                <td>{data.update}</td>
                                <td className='tddown-arrow active-table'>                             
                                    {data.active}
